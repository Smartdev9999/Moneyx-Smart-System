...
//|               Asset Miner EA v3.0 - MTF ZigZag+CDC+Grid+License  |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, MoneyX Smart System"
#property link      "https://moneyxsmartsystem.lovable.app"
#property version   "3.00"
#property description "Asset Miner EA v3.0 - MTF ZigZag Entry + CDC Filter + License + News + Time Filter"
#property strict
...
void OnDeinit(const int reason)
{
   ...
   Print("Asset Miner EA v3.0 deinitialized");
}
...
void DisplayDashboard()
{
   ...
   //--- Header
   string headerVersion = (EntryMode == ENTRY_SMA) ? "Asset Miner EA v3.0 [SMA]" : "Asset Miner EA v3.0 [ZZ]";
